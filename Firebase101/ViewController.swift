...
//  Firebase101
//
//  Created by Minseok Bang on 2020/12/16.
//
...
//        deleteBasicTypes()
    ...
    @IBAction func updateTypes(_ sender: Any) {
        updateBasicTypes()
    }
    @IBAction func deleteTypes(_ sender: Any) {
        deleteBasicTypes()
...
extension ViewController {
    func updateBasicTypes(){
        ...
        db.updateChildValues(["str": "String Value : 업데이트된 안녕"])
//        db.child("int").setValue(3)
//        db.child("double").setValue(3.5)
//        db.child("str").setValue("String Value : 여러분안녕")
    }
